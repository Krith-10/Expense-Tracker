...
function addListItem(obj) {
  ...
  //sign in the template string for new <li>
...
function updateValues(arr) {
  ...
  myIncome.innerText = `Rs: ${incomeTotal}`;
  myExpenses.innerText = `Rs: ${expenseTotal}`;
  myBalance.innerText = `Rs: ${balance}`;
}
...
function removeListItem(id) {
  ...
  if (historyList.children.length === 0) {
    console.log("empty");
    myIncome.innerText = "Rs:0.00";
    myExpenses.innerText = "Rs:0.00";
    myBalance.innerText = "Rs:0.00";
  }
}
